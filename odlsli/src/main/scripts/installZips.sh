...
echo "Installing SDN-C core version ${CCSDK_CORE_VERSION}"
...
echo "Installing SDN-C adaptors version ${CCSDK_ADAPTORS_VERSION}"
...
echo "Installing SDN-C northbound version ${CCSDK_NORTHBOUND_VERSION}"
...
echo "Installing SDN-C plugins version ${CCSDK_PLUGINS_VERSION}"
